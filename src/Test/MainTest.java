...
//        Customer customer1 = new Customer(1, "John Doe", "123 Main St.", "555-555-5555", "password1");
//        Account account1 = new Account(1, customer1.getName(), 1000, 3456);
//        customer1.addAccount(account1);
//        bank.addAccount(account1);
//
//        Customer customer2 = new Customer(2, "Jane Smith", "456 Park Ave.", "555-555-5556", "password2");
